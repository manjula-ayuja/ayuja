...
const PaymentMethodSelectionScreen = () => {
  ...
  const { name, dob, phone, gender, selectedDate, serviceTitle, serviceImage } = route.params || {};
    ...
    return (
      ...
      >
        ...
        <View style={styles.optionLeft}>
          {item.type === "wallet" && <MaterialIcons name={item.icon} size={22} color="#008080" />}
          {item.type === "visa" && <FontAwesome name={item.icon} size={28} color="#1A1F71" />}
          {item.type === "mastercard" && <FontAwesome name={item.icon} size={28} color="#EB001B" />}
          {item.type === "upi" && <FontAwesome5 name={item.icon} size={22} color="#008080" />}
          {item.type === "offline" && <MaterialCommunityIcons name={item.icon} size={22} color="#008080" />}
